...
class TwoLetterQuiz extends StatefulWidget {
  TwoLetterQuiz({super.key});
  @override
  State<TwoLetterQuiz> createState() => _TwoLetterQuizState();
}

class _TwoLetterQuizState extends State<TwoLetterQuiz> {
  int i = 0;
  final TextEditingController _twoletterController = TextEditingController();
  ...
  void getWords() async {
    ...
    final x = await rootBundle.loadString("assets/csvfile/twos.csv");
    setState(() {
    ...
    setState(() {
      if (uniqueWords.contains(_twoletterController.text.toLowerCase())) {
        ...
        if (!incorrectGuesses
          ...
          incorrectGuesses.add(_twoletterController.text.toUpperCase());
        }
      }
    });

    _twoletterController.clear();
  }
  ...
  void initState() {
    super.initState();
    getWords();
    _twoletterController.addListener(() {
      final String text = _twoletterController.text.toUpperCase();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('2 letter words',
            style: TextStyle(
              fontSize: 20,
            )),
            ...
            child: Row(
              children: [
                Expanded(
                  ...
                  child: TextField(
                    controller: _twoletterController,
